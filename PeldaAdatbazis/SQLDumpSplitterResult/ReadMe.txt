...
If you want to restore the dump, you have to execute the file nutridb-database-sr28_DataStructure.sql first because it contains the structure like Tables.
